...
\draw[<-,black,ultra thick] (0.9,1.3) --(0.1,1.3);
\node[above left] at (0,1) {$Abraham$};

\draw[->,yellow,ultra thick] (-0.2,0.9) --(-0.2,0.1);
\draw[<-,black,ultra thick] (-0.3,0.9) --(-0.3,0.1);
\node[below left] at (0,0) {$Bethany$};

\draw[->,orange,ultra thick] (0.1,-0.2) --(0.9,-0.2);
\draw[<-,black,ultra thick] (0.1,-0.3) --(0.9,-0.3);
\node[below right] at (1,0) {$Chad$};

\draw[->,green,ultra thick] (1.2,0.1) --(1.2,0.9);
\draw[<-,black,ultra thick] (1.3,0.1) --(1.3,0.9);
\node[above right] at (1,1) {$Dorus$};
\end{tikzpicture}
\caption{Using money to decompose the flow of assets into four local transactions. Money is the traditional standard solution for clearing trade between strangers, and requires a monetary token to travel in the counter-direction of the trade flow (black arrows). Each participant takes a devaluation risk from the moment they accept the token to the moment they successfully forward it.}
\end{figure}

\begin{figure}
\begin{tikzpicture}[scale=0.92]
\draw[->,cyan,ultra thick] (1.2,1.2) --(0.1,1.2);
\draw [fill=black] (0,1) circle [radius=0.1];

\draw[->,cyan,ultra thick] (-0.2,0.9) --(-0.2,-0.2);
\draw [fill=black] (0,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (-0.2,-0.2) --(1.2,-0.2);
\draw [fill=black] (1,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (1.2,-0.2) --(1.2,1.2);
\draw [fill=black] (1,1) circle [radius=0.1];


\draw[->,cyan,ultra thick] (4.2,1.2) --(3.1,1.2);
\draw[<-,magenta,ultra thick] (4.4,1.4) --(3.1,1.4);
\draw[->,red,ultra thick] (3.9,1.0) --(3.1,1.0);
\draw [fill=black] (3,1) circle [radius=0.1];

\draw[->,cyan,ultra thick] (2.8,0.9) --(2.8,-0.2);
\draw [fill=black] (3,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (2.8,-0.2) --(4.2,-0.2);
\draw [fill=black] (4,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (4.2,-0.2) --(4.2,1.2);
\draw [fill=black] (4,1) circle [radius=0.1];


\draw[->,cyan,ultra thick] (7.2,1.2) --(6.1,1.2);
\draw[<-,magenta,ultra thick] (7.4,1.4) --(6.1,1.4);
\draw[->,red,ultra thick] (6.9,1.0) --(6.1,1.0);
\draw [fill=black] (6,1) circle [radius=0.1];

\draw[->,cyan,ultra thick] (5.8,0.9) --(5.8,-0.2);
\draw [fill=black] (6,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (5.8,-0.2) --(7.2,-0.2);
\draw [fill=black] (7,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (7.2,-0.2) --(7.2,1.2);
\draw[<-,magenta,ultra thick] (7.4,-0.4) --(7.4,1.4);
\draw[->,green,ultra thick] (7,0.1) --(7,0.9);
\draw [fill=black] (7,1) circle [radius=0.1];


\draw[->,cyan,ultra thick] (10.2,1.2) --(9.1,1.2);
\draw[<-,magenta,ultra thick] (10.4,1.4) --(9.1,1.4);
\draw[->,red,ultra thick] (9.9,1.0) --(9.1,1.0);
\draw [fill=black] (9,1) circle [radius=0.1];

\draw[->,cyan,ultra thick] (8.8,0.9) --(8.8,-0.2);
\draw [fill=black] (9,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (8.8,-0.2) --(10.2,-0.2);
\draw[<-,magenta,ultra thick] (8.6,-0.4) --(10.4,-0.4);
\draw[->,orange,ultra thick] (9.1,0) --(9.9,0);
\draw [fill=black] (10,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (10.2,-0.2) --(10.2,1.2);
\draw[<-,magenta,ultra thick] (10.4,-0.4) --(10.4,1.4);
\draw[->,green,ultra thick] (10,0.1) --(10,0.9);
\draw [fill=black] (10,1) circle [radius=0.1];


\draw[->,cyan,ultra thick] (13.2,1.2) --(12.1,1.2);
\draw[<-,magenta,ultra thick] (13.4,1.4) --(12.1,1.4);
\draw[->,red,ultra thick] (12.9,1.0) --(12.1,1.0);
\draw [fill=black] (12,1) circle [radius=0.1];

\draw[->,cyan,ultra thick] (11.8,0.9) --(11.8,-0.2);
\draw[<-,magenta,ultra thick] (11.6,0.9) --(11.6,-0.4);
\draw[->,yellow,ultra thick] (12,0.9) --(12,0.1);
\draw [fill=black] (12,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (11.8,-0.2) --(13.2,-0.2);
\draw[<-,magenta,ultra thick] (11.6,-0.4) --(13.4,-0.4);
\draw[->,orange,ultra thick] (12.1,0) --(12.9,0);
\draw [fill=black] (13,0) circle [radius=0.1];

\draw[->,cyan,ultra thick] (13.2,-0.2) --(13.2,1.2);
\draw[<-,magenta,ultra thick] (13.4,-0.4) --(13.4,1.4);
\draw[->,green,ultra thick] (13,0.1) --(13,0.9);
\draw [fill=black] (13,1) circle [radius=0.1];
\end{tikzpicture}
\caption{First, a \textbf{\color{cyan} LedgerLoops challenge} is sent around. Each participant uses the challenge to create a cryptographically triggered IOU. Then, the originator solves the challenge and sends the \textbf{\color{magenta} LedgerLoops trigger} around in the opposite direction. This safely coordinates all four transactions by triggering all of them in one atomic event.}
\end{figure}
...
\section{The LedgerLoops Protocol (version 0.6)}
...
As Graeber noted in his book "Debt: the first 5,000 years" ~\cite{Graeber2011}, peer-to-peer debt is useful for time-skewed barter between two peers; I give you something now, and you give me something in exchange tomorrow; in the meantime, a debt exists. This is why LedgerLoops is based on peer-to-peer ledgers (that is, ledgers on which two people keep track of what they owe each other).
...
{
  "protocol": "local-ledgers-0.2",
  "msgType": "initiate-update",
  "transactionId": "<a unique string>",
  "note": "<a description of why this IOU is being sent>,
  "debtor": "<identifier of the sender; just a nickname>",
  "addedDebts": {
    "unit": amount, // for instance "USD": 10,
  },
}
\end{lstlisting}}
...
\vbox{\begin{lstlisting}
{
  ...
  "transactionId": "<same as in initiate-update message>",
}
\end{lstlisting}}
...
\vbox{\begin{lstlisting}
{
  "protocol": "ddcd-dfs-0.2",
  "msgType": "update-status",
  "value": "<true iff sending node might be on cycle>",
...
The pathTokens which are included in addition to treeTokens are refreshed after each backtrack step, to avoid the full probe details from leaking to nodes that did not participate in the cycle which the probe finds; each node can remember what the last out-neighbor was they sent this treeToken to. However, a node may decide that its out-neighbor is unreachable, and after some timeout continue trying with the next sibling. Once this happens, it would be possible to find multiple cycles on one treeToken (but they would then have different pathTokens).

If the probe reaches a node which it has already visited, this node has discovered a cycle, and can try to become the initiator of a LedgerLoop.

\subsection{Cryptographically triggered IOUs}

The initiator generates a random string and calculates its SHA-256 hash value. It then sends the following message to the out-neighbor to which it sent the treeToken that looped around:

\vbox{\begin{lstlisting}
{
  "protocol": "ledgerloops-0.6",
  "msgType": "conditional-promise",
  "transaction": {
    "id": "<a newly generated unique string>",
    "unit": "<something the sender has to offer>",
  ...
  "routing": {
    "protocol": "ddcd-dfs-0.2",
    "treeToken": "<the treeToken of detected loop>",
    "pathToken": "<the pathToken that looped back>",
  },
}
\end{lstlisting}}
...
\vbox{\begin{lstlisting}
{
  ...
  "transactionId": "<transaction.id from earlier>",
